...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message:
        'Released under the MIT License. · <a href="/ReproJs/privacy">Privacy policy</a> · <a href="https://buymeacoffee.com/ripwords" target="_blank" rel="noopener">Buy me a coffee ☕</a>',
